    ...
    <div className="about-view">
      <div className="about-card">
        ...
        <ul>
          ...
          <li>
            <b>Просмотр.</b> Полярные и декартовы КСС в плоскостях C0–C180 и C90–C270, ось истинного максимума,
            полный угол 2γ½ и тип КСС по каждой плоскости отдельно. Рядом — поток, поток вниз/вверх, DFF/UFF, КПД,
            лм/Вт, Imax в канделах и кд/клм, а также список замечаний к файлу.
          </li>
          <li>
        ...
        <p>
          ...
          можно сравнить. Кнопка <b>«Выгрузить»</b> скачивает активный файл на компьютер. Кнопка{' '}
          <b>«Отменить изменения»</b> возвращает файл к состоянию на момент загрузки.
        </p>

        <h3>Лицензия и правообладатель</h3>
        <p>
          © 2026 Александр Лустинов. Программа свободная: распространяется по лицензии{' '}
